...
def RandomForest():
    ...
    # Graph b/w predicted and actual

    import matplotlib.pyplot as plt
    plt.scatter(y_pred, y_test, edgecolors='green', color='black')
    plt.xlabel("Predicted")
    plt.ylabel("Actual")
    plt.title("Actual vs Predicted(Random Forest)", loc='center')
    plt.show()
...
def extraTree():
    ...
    clf4 = ExtraTreesClassifier(n_estimators=1000,max_depth=200,min_samples_split=5,random_state=45)
    ...
    plt.xlabel("Predicted")
    plt.ylabel("Actual")
    plt.title("Actual vs Predicted(Extra Tree)", loc='center')
    plt.show()
...
def NaiveBayes():
    ...
    plt.xlabel("Predicted")
    plt.ylabel("Actual")
    plt.title("Actual vs Predicted(Naive Baye's)", loc='center')
    plt.show()
    #GUI Functionality ---------------------------------------------------------------------->
...
def SVMFun():
    ...
    from sklearn.ensemble import ExtraTreesClassifier
    clf3 = ExtraTreesClassifier(n_estimators=1000,max_depth=200,min_samples_split=5,random_state=45)  # empty model of the decision tree
    clf3 = clf3.fit(X,np.ravel(y) )
    ...
    plt.xlabel("Predicted")
    plt.ylabel("Actual")
    plt.title("Actual vs Predicted(SVM)",loc='center')
    plt.show()
